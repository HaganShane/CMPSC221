...
public class Player extends MobileCharacter {
    public Player() {
        ...
        inventorySystem = new InfiniteInventorySystem();
        inventorySystem = new FiniteInventorySystem(15);  // Player can hold 15 items maximum
        inventorySystem = new LimitedBulkinessInventorySystem(8);  // Max bulkiness set to 8
        inventorySystem = new LimitedWeightInventorySystem(7);  // Max weight player is able to hold set to 7
    } /* end Player */
...
} /* end Player (code from class adventure) */
